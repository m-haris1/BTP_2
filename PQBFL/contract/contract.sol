...
contract PQB_FederatedLearning {
    ...
    mapping(uint => mapping(address => UpdatedModel)) public updatedModels;
    ...
    function updateModel(uint r, string memory HashModel,string memory hash_ct_epk, uint Task_id, uint project_id) external {
        ...
        updatedModels[Task_id][clientAddress] = updatedModel;
  // Store updated model info in the 'updatedModels' mapping
